...
# Get speech-based commands from ros parameters.
play_greeted_param = rospy.get_param(anm.PARAM_SPEECH_COMMANDS)
# Keyword that the user can say to start the interaction, e.g., "Hello".
PLAY_TAG = play_greeted_param[0]
# Keyword that the user can say to stop the interaction, e.g., "Bye".
